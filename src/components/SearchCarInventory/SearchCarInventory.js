...
class SearchCarInventory extends React.Component {
  ...
  getFilteredCars = (newFilteredCars) => {
    // this.setState(() => {
    //   return {
    //     filteredCars: newFilteredCars 
    //   }
    // }, () => {
    //   return console.log(this.state.filteredCars);
    // });
      ...
      <div className="carInv">
        <div className="build_price-header">2019 {title} Inventory</div>
          <div className="carInv-mainFlex">
            <div className="carInv-leftContainer">
              ...
              <div>
                ...
                <TrimCheckbox allCars={this.state.allCars} filteredCars={this.state.filteredCars} getFilteredCars={this.getFilteredCars}/>
                <EngineCheckbox />
          ...
          <div className="carInv-rightContainer">
            ...
            <div>
              <Showcase allCars={this.state.allCars} filteredCars={this.state.filteredCars} trim={this.state.trim}/>
            </div>
          </div>
        </div>
      </div>
